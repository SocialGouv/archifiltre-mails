...
import {
    ...
    createRoot,
    createText,
} from "../../../common/workspace-bubble-constructor";
import { LayoutWorkspace } from "../../components/common/layout/LayoutWorkspace";
import { ClosePicto } from "../../components/common/pictos/picto";
import { useWorkspaceRouteContext } from "../../context/WorkspaceRouter";
import style from "./WorkspaceBubble.module.scss";
...
export const WorkspaceBubble: React.FC = () => {
    const { backHome } = useWorkspaceRouteContext();
    ...
    return (
        <LayoutWorkspace classname={style.bubble}>
            <button className={style.close} onClick={backHome}>
                <ClosePicto />
            </button>
            <svg
